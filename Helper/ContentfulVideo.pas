...
type
  ...
  public
    ...
    function Upload(FilePath,Filename:String):String;
    function CreateAssets(UploadId,Title,Filename:String):TJSONObject;
    ...
    procedure DeleteVdo(assetId:String;version:Integer);
...
function MContentfulVideo.Upload(FilePath,Filename:String): String;
var UploadId : String;
begin
  var vdoFile := TFileStream.Create(FilePath, fmOpenRead);
...
function MContentfulVideo.CreateAssets(UploadId,Title,Filename:String):TJSONObject;
var ResultRest:TJSONObject;
begin
    var today := Now;
    ResultRest := TJSONObject.Create;
...
procedure MContentfulVideo.DeleteVdo(assetId: String;version : Integer);
begin
...
function MContentfulVideo.GetById(assetid: String):TMemoryStream;
begin
    var CPAClient := TRESTClient.Create(nil);
    var CPARequest := TRESTRequest.Create(nil);
    CPARequest.AddParameter('Authorization','Bearer '+CmaToken,pkHTTPHEADER,[poDoNotEncode]);
...
function MContentfulVideo.GetVersionById(assetid: String): Integer;
begin
    var CPAClient := TRESTClient.Create(nil);
    var CPARequest := TRESTRequest.Create(nil);
    CPARequest.AddParameter('Authorization','Bearer '+CmaToken,pkHTTPHEADER,[poDoNotEncode]);
...
function MContentfulVideo.ProcessAssets(AssetId:String):Boolean;
...
function MContentfulVideo.PublishAssets(assetId: String; version: Integer):Integer;
begin
    var CPAClient := TRESTClient.Create(nil);
    var CPARequest := TRESTRequest.Create(nil);
    CPARequest.AddParameter('Authorization','Bearer '+CmaToken,pkHTTPHEADER,[poDoNotEncode]);
...
function MContentfulVideo.UnPublishAssets(assetId: String; version: Integer):Integer;
begin
    var CPAClient := TRESTClient.Create(nil);
    var CPARequest := TRESTRequest.Create(nil);
    CPARequest.AddParameter('Authorization','Bearer '+CmaToken,pkHTTPHEADER,[poDoNotEncode]);
...
function MContentfulVideo.LoadImage(url: string): TMemoryStream;
begin
    var MS := TMemoryStream.Create;
    var NetClient := TNetHTTPClient.Create(Nil);
    var NetHTTP := TNetHTTPRequest.Create(Nil);
